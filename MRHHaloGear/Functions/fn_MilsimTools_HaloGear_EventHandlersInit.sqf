...
//set freefall eh
["MRH_StartedFreefall_eh", {FUNC(AADOpening);FUNC(randomBreakingChance)}] call CBA_fnc_addEventHandler;
["MRH_freefallEnded_eh", {FUNC(attachAceAttachable)}] call CBA_fnc_addEventHandler;
